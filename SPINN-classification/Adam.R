...
adam <- function(k, alpha, beta1, beta2,
                 first_moment_1, first_moment_2, 
                 second_moment_1, second_moment_2, 
                 w1, w2, dJw1, dJw2, epoch){
  first_moment_1 <- beta1 * first_moment_1 + (1 - beta1) * dJw1
  first_moment_2 <- beta1 * first_moment_2 + (1 - beta1) * dJw2
  second_moment_1 <- beta2 * second_moment_1 + (1 - beta2) * dJw1 * dJw1
  second_moment_2 <- beta2 * second_moment_2 + (1 - beta2) * dJw2 * dJw2
